...
public abstract class RailRendering extends EntityWithOwnerRendering {
	 ...
	 * fold the opposite four back onto the defined four. Factorio normally writes one of the first
	 * four, but a segment laid in the opposite direction of travel can be serialized as one of the
	 * others.
	 */
	...
	/**
	 * Folds the last four directions onto the first four, for rails whose shape is unchanged by a
	 * half turn.
	 */
	protected static Direction foldHalfTurn(Direction direction) {
